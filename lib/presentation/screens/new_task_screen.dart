  ...
  TaskProvider taskProvider = context.read<TaskProvider>();
    ...
    return PopScope(
      onPopInvokedWithResult: (bool didPop, result) {
        if(didPop){
          // TODO: Local addTask method for veryfiying empty text and checklist
        }
      },
      child: Scaffold(
          appBar: AppBar(
            ...
            actions: [
              IconButton(
                ...
                onPressed: () {
                  taskProvider.addTask(Task.create(title: titleController.text, checkList: checkList));
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: TextField(
                                      ...
                                      onTapOutside: (event) {
                                        setState(() {
                                          if (controllerList[index].text.trim().isEmpty) {
                                            controllerList[index].text = 'No text';
                                          }
                                        });
                      ...
                      child: TextButton.icon(
                        ...
                        onPressed: () {
                          setState(() {
                            ...
                            checkList.add(TaskCheck.create('', false));
                            controllerList.add(newTextController);
